...
protocol ChooseLanguageViewModel: MoviesListViewModelInput, MoviesListViewModelOutput {}
...
final class DefaultChooseLanguageViewModel: ChooseLanguageViewModel {
    ...
    private let moviesListUseCase: ChooseLanguageUseCase
    ...
    init(moviesListUseCase: ChooseLanguageUseCase,
